...
<body>
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item" data-aos="fade-down" data-aos-delay="300">
                        <a class="nav-link active" href="data_dosen.php">Dosen</a>
                    </li>
    ...
    <div class="container-fluid container-1">
        <div class="menu-item menu-desc shadow" data-aos="fade-right" data-aos-duration="1000">
            ...
            <center><a href="form_dosen.php"><button type="submit" class="btn btn-outline-primary">Tambah Dosen</button></a></center>
            <br>
            <table class="table">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    if (isset($_POST['sort']) && $_POST['sort'] != "No Sorting") {
                        $sort = $_POST['sort'];
                        $query = mysqli_query($connect, "SELECT * FROM DOSEN ORDER BY $sort ASC");
                    } else {
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php print $dosen['email']; ?></td>
                            <td><?php print $dosen['Nama']; ?></td>
                            <td><?php print $dosen['NIP']; ?></td>
                            <td><?php print $dosen['BidangStudi']; ?></td>
                            <td><?php print $dosen['password']; ?></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
