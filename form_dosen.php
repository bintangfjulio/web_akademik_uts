...
<body>
    ...
    <div class="container-fluid container-1">
        <div class="menu-item menu-desc shadow" data-aos="fade-right" data-aos-duration="1000">
            <center>
                <h5 class="typing">Formulir Data Dosen</h5>
            </center>

            <form action="config/insert_dosen.php" method="post">
                <br>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="BidangStudi" placeholder="Masukkan Bidang Studi" class="form-control" required />
                </div>
                <br>
                <div class="form-group">
